...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { category_id: @race.category_id, description: @race.description, name: @race.name }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { category_id: @race.category_id, description: @race.description, name: @race.name }
    assert_redirected_to race_path(assigns(:race))
  end
